...
function Notice3() {
  ...
  const [notice3, setNotice3] = React.useState([]);
  ...
  const 작성 = async () => {
    await axios({
      ...
      if (response.data.code === "success") {
        window.location.replace("/notice3");
      }
    });
  };
      ...
      {modalOpen && (
        <div>
          ...
          <div className="modal">
            ...
            <div className="pre-box-1">모로코</div>
            <button
              onClick={() => {
                setNum(num + 1);
              }}
            ...
            <span>
              ...
              <div className="pre-box-2">스페인</div>
            ...
            <button className="match-box-btn2">
              <span className="match-team2">
                <span className="match-team-img2">
                  <img
                    className="qw"
                    src="https://sports-phinf.pstatic.net/team/qatar2022/default/4698.png"
                  />
                </span>
              </span>
            </button>
